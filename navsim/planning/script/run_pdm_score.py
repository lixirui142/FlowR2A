...
# I’ve already fixed it by reducing the thread count or the number of workers.
...
def main(cfg: DictConfig) -> None:
    ...
    for dp in data_points:
        ...
        tokens_list = dp["tokens"]
        split_dp = [
            {
                "cfg": cfg,
                "log_file": log_file,
                "tokens": tokens_list[i:i + chunk_size],
            } for i in range(0, len(tokens_list), chunk_size)
        ]
        new_data_points += split_dp
