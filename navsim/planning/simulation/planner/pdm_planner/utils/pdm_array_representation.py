...
from navsim.planning.simulation.planner.pdm_planner.utils.pdm_enums import BBCoordsIndex, SE2Index, StateIndex, PointIndex
...
def state_array_to_center_state_array(
    ...
    """
    Converts a rear-axle state array to a vehicle-center state array.
    :param state_array: array of rear-axle states (..., StateIndex.size())
    :param vehicle_parameters: vehicle parameters (for rear_axle_to_center distance)
    :return: array of center states with shifted position, velocity, and acceleration
    """
